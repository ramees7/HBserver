...
// -----------------------------------------------------------
router.post('/admin/addcata',jwtMiddleware,multerConfig.single('dept_image'),catagoryController.addcatagory)
router.get('/admin/getcata',jwtMiddleware,catagoryController.findCata)
// router.get('/admin/getspecifieddept',jwtMiddleware,catagoryController.findSpecifiedDept)
router.post('/admin/pushcata/:id',jwtMiddleware,multerConfig.single('dr_image'),catagoryController.pushCata)
router.delete('/admin/deletedept/:id',jwtMiddleware,catagoryController.deletDepartment)
// ---------------------------------------------------------
...
router.delete('/admin/deletereview/:id',jwtMiddleware,adminController.deleteReview)
